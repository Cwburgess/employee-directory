  ...
  const filteredGroups = useMemo(() => {
    ...
    return (data as CrewGroup[])
      .map((g) => {
        ...
        const members = lSet.size
          ? (g.members || []).filter((m) => lSet.has(m.location || ""))
          : g.members || [];
  ...
  return (
    <main className="p-6">
      ...
      {loading ? (
        ...
        <div className="mt-6 md:mt-8 grid gap-4 justify-center [grid-template-columns:repeat(auto-fill,minmax(320px,400px))]">
